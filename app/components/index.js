...
export PricingAppAvocat from './LandingPage/PricingAppAvocat';
...
export CrudFolderTableForm from './Tables/CrudFolderTableForm';
...
// CaseWorker
export AddCaseWorker from './CaseWorker/AddCaseWorker';
export CaseWorkerList from './CaseWorker/CaseWorkerList';
export CaseWorkerDetail from './CaseWorker/CaseWorkerDetail';
// Customer
export AddCustomer from './Customer/AddCustomer';
export CustomerList from './Customer/CustomerList';
export CustomerDetail from './Customer/CustomerDetail';
// Chat
