...
import RowReadOnlyFolder from './RowReadOnlyFolder';
import styles from '../tableStyle-jss';

class MainFolderTableForm extends React.Component {
  render() {
    const {
      title,
      classes,
...
export default withWidth()(withStyles(styles)(MainFolderTableForm));
