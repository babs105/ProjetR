...
class SubscriptionForm extends React.Component {
  ...
  render() {
    const {
      ...
      goToPremium,
      goToBasic,
      previousPage,handleSubmit,pristine, submitting
    } = this.props;
      ...
      <Fragment>
        <Grid container justify="left" spacing={24}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Grid container justify="center" spacing={24}>
              <Grid item>
                <Button variant="contained" color="primary" size="large" onClick={previousPage}>
                            Back
                </Button>
              </Grid>
              <Grid item>
...
const SubscriptionFormReduxed = reduxForm({
  form: 'subscriptionForm',
  enableReinitialize: true
})(SubscriptionForm);

export default withStyles(styles)(SubscriptionFormReduxed);
