...
class Header extends React.Component {
  state = {
    ...
    menuList: [
      ...
      createData('login', '/login-v2'),
      createData('register', '/register-v2'),
    ]
  }
        ...
        >
          ...
          <div className={classes.container}>
            <div className={classes.spaceContainer}>
              ...
              <Hidden mdDown>
                <nav>
                  <Scrollspy items={['feature', 'showcase', 'testimonials', 'pricing', 'contact', 'login', 'register']} currentClassName="active">
                    { menuList.map(item => {
