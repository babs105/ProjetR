...
class CustomerList extends React.Component {
  ...
  render() {
    ...
    const favoriteData = dataCustomer.filter(item => item.get('favorited') === true);
    const getItem = dataArray => dataArray.map(data => {
      const index = dataCustomer.indexOf(data);
      ...
      <Fragment>
        ...
        >
          <div>
              ...
              <div className={classes.flex}>
                ...
                {addFn && (
                  <Tooltip title="Add New Customer">
                    <IconButton className={classes.buttonAdd} onClick={() => addCustomer()} color="secondary" aria-label="Delete">
                      <Add />
                    </IconButton>
                  </Tooltip>
                )}
            ...
            <List>
              {filter === 'all' ? getItem(dataCustomer) : getItem(favoriteData)}
            </List>
          </div>
        </Drawer>
