...
import {
  ...
  ProductPage, Invoice, UserProfile, BlankPage,
...
import directory from '../Tables/demos/AppAvocat/DirectoryTable';
import folder from '../Tables/demos/AppAvocat/Folder';
import PrivateRoute from '../../utils/PrivateRoute';
import caseworker from '../Tables/demos/AppAvocat/CaseWorker';
import document from '../Tables/demos/AppAvocat/Document';
import customer from '../Tables/demos/AppAvocat/Customer';
import timeline from '../Tables/demos/AppAvocat/TimeLine';
import userProfile from '../Tables/demos/AppAvocat/UserProfile';
import registration from '../Tables/demos/AppAvocat/Registration';
    ...
    return (
      <Dashboard history={history} changeMode={changeMode}>
        <Switch>
          ...
          { /* AppAvocat */ }
          <PrivateRoute path="/app/directory" component={directory} />
          <PrivateRoute path="/app/folders" component={folder} />
          <Route path="/app/document" component={document} />
          <Route path="/app/caseworker" component={caseworker} />
          <Route path="/app/registration" component={registration} />
          <PrivateRoute path="/app/timeline" component={timeline} />
          <PrivateRoute path="/app/user-profile" component={userProfile} />
          <PrivateRoute path="/app/customer" component={customer} />
          { /* Map */ }
